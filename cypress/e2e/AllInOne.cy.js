before('VisitLogIn', function(){
//here we write befoer and after so it will log in just in the fist function and loh out in just last function
...
it('Add Delete Embloyee',    function(){
...
cy.wait(3000);
// type username 
cy.get(':nth-child(4) > .oxd-input-group > :nth-child(2) > .oxd-input').type('Ghaidaa');
cy.wait(3000);
//full password 
...
//type usename 
cy.get(':nth-child(2) > .oxd-input').type('Ghaidaa');  
//user role 
...
//DATE OF BIRTH
cy.get(':nth-child(1) > .oxd-input-group > :nth-child(2) > .oxd-date-wrapper > .oxd-date-input > .oxd-input').clear().type('2004-03-25');
cy.wait(3000);
